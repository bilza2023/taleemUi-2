...
import { R as RESOURCE_URL } from './config-eP_VXicv.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${$$result.head += `<!-- HEAD_svelte-4gaj3s_START --><script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-4279476755172786" crossorigin="anonymous" data-svelte-h="svelte-6169bd"><\/script><!-- HEAD_svelte-4gaj3s_END -->`, ""}  ${validate_component(Nav, "Nav").$$render($$result, {}, {}, {})} ${validate_component(PageWrapper, "PageWrapper").$$render($$result, {}, {}, {
    default: () => {
...
//# sourceMappingURL=_page.svelte-xPeIk-ME.js.map
