import { c as create_ssr_component } from './ssr-fIbI7xQ0.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${$$result.head += `<!-- HEAD_svelte-1i48p6k_START --><link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/katex@0.15.2/dist/katex.min.css" integrity="sha384-MlJdn/WNKDGXveldHDdyRP1R4CTHr3FeuDNfhsLPYrq2t0UBkUdK2jyTnXPEK1NQ" crossorigin="anonymous"><!-- HEAD_svelte-1i48p6k_END -->`, ""}  <div class="bg-gray-800 text-white w-full min-h-screen" style="position: fixed; top: 0;">${``} ${``} </div>`;
});

export { Page as default };
//# sourceMappingURL=_page.svelte-2569j0IM.js.map
